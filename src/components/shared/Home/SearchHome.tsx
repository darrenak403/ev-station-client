...
import image1 from "../../../../public/Images/imageHome.webp";

const SearchHome = () => {
  return (
    <div className="max-w-6xl h-[500px] relative mx-auto">
      <div className="w-100 h-[500px] overflow-hidden rounded-2xl shadow-lg">
        <Image
          src={image1}
          alt="Image 1"
          fill
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded shadow-lg">
        ...
        <div className=" relative top-30 w-1/2  mx-auto text-center bg-green-500 text-white px-3 py-3 rounded-t-2xl rounded-b-none text-xl font-semibold shadow-lg hover:bg-green-600 cursor-pointer">
          Xe Tự Lái
        </div>
        <div className="bg-white rounded-2xl shadow-lg p-5 mx-auto relative top-30 right-3 h-30 relative dark:bg-black">
          <div className="flex items-center mb-4 p-2 rounded dark:text-white">
            <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24"><path fill="currentColor" fillRule="evenodd" d="m15.801 2.037l-3.496 3.978a3 3 0 0 1 2.614 2.291l3.42-3.894A7.9 7.9 0 0 0 15.8 2.037Zm-1.426-.649l-4.222 4.803l-3.237-3.217C8.276 1.752 10.064 1 12 1c.826 0 1.624.137 2.375.388m4.72 4.436L8.693 17.67q.31.395.62.807c.996 1.34 1.383 2.457 1.656 3.245c.282.815.443 1.279 1.031 1.279s.749-.464 1.031-1.279c.273-.788.66-1.905 1.657-3.245c.434-.585.878-1.14 1.313-1.685c1.908-2.385 3.651-4.565 3.651-8.139a7.5 7.5 0 0 0-.557-2.828ZM7.743 16.478l3.947-4.494a3 3 0 0 1-2.611-2.299L5.67 13.563c.582 1.022 1.308 1.959 2.072 2.915ZM4.968 12.09L9.16 7.32L5.9 4.08a7.57 7.57 0 0 0-1.552 4.572c0 1.305.232 2.425.62 3.438" clipRule="evenodd"></path></svg>
            <span className="ml-2 dark:text-white">Địa điểm</span>
          </div>
          <span className="top-15 left-15 font-semibold text-3xl absolute dark:text-white">Hồ Chí Minh</span>
