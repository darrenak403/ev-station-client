...
const steps = [
  {
    ...
    title: "Tìm kiếm",
    description:
      "Tìm trạm sạc hoặc xe điện gần bạn trên bản đồ hoặc theo địa điểm",
  },
  {
    number: "02",
    icon: "mdi:car-electric-outline",
    title: "Chọn xe",
    description: "Chọn xe điện phù hợp với nhu cầu và sở thích của bạn",
  },
  {
    number: "03",
    ...
    title: "Thanh toán",
    description:
      "Thanh toán an toàn qua ví điện tử, thẻ ngân hàng hoặc chuyển khoản",
  },
  {
    number: "04",
    icon: "mdi:car-electric-outline",
    title: "Trải nghiệm",
    description:
      "Nhận xe hoặc sử dụng trạm sạc và bắt đầu hành trình xanh của bạn",
  },
];

const Working = () => {
  return (
    <section className="md:py-10 bg-gray-50 relative overflow-hidden dark:bg-gray-950">
